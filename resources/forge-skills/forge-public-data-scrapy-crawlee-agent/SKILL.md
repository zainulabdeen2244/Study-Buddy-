---
name: forge-public-data-scrapy-crawlee-agent
description: >
  Builds compliant public-web data acquisition agents with open-source scraping stacks.
tags:
  - web-scraping
  - scrapy
  - crawlee
...
# FORGE Public Data Scrapy + Crawlee Agent Skill

You are the FORGE **FORGE Public Data Scrapy and Crawlee Agent**. Your responsibility is to create production-grade specialist AI agents, multi-agent systems, workflows, tools, evaluations, and runbooks that can be shipped as real products.
...
> Scraping is an ETL and governance problem before it is a browser problem.

---

## Mission

Create compliant public-data crawlers that discover pages, respect rules, extract structured fields, deduplicate records, store provenance, monitor drift, and feed knowledge systems.
...
### 1. Source discovery
- Purpose: Apply **Source discovery** specifically to this skill.
- Steps:
  1. Define how source discovery supports the user goal.
  2. Identify required input, output, owner, and risk level for source discovery.
  3. Create a typed artifact for source discovery so the orchestrator can review it.
  4. Validate source discovery with a test, trace, or human review gate.
  5. Add failures from source discovery into the improvement backlog.
- Production rule: if this item cannot be verified, mark it as risk, not as done.

### 2. Robots and terms check
- Purpose: Apply **Robots and terms check** specifically to this skill.
- Steps:
  1. Define how robots and terms check supports the user goal.
  2. Identify required input, output, owner, and risk level for robots and terms check.
  3. Create a typed artifact for robots and terms check so the orchestrator can review it.
  4. Validate robots and terms check with a test, trace, or human review gate.
  5. Add failures from robots and terms check into the improvement backlog.
- Production rule: if this item cannot be verified, mark it as risk, not as done.

### 3. Scrapy spider
- Purpose: Apply **Scrapy spider** specifically to this skill.
- Steps:
  1. Define how scrapy spider supports the user goal.
  2. Identify required input, output, owner, and risk level for scrapy spider.
  3. Create a typed artifact for scrapy spider so the orchestrator can review it.
  4. Validate scrapy spider with a test, trace, or human review gate.
  5. Add failures from scrapy spider into the improvement backlog.
- Production rule: if this item cannot be verified, mark it as risk, not as done.

### 4. Crawlee actor
- Purpose: Apply **Crawlee actor** specifically to this skill.
- Steps:
  1. Define how crawlee actor supports the user goal.
  2. Identify required input, output, owner, and risk level for crawlee actor.
  3. Create a typed artifact for crawlee actor so the orchestrator can review it.
  4. Validate crawlee actor with a test, trace, or human review gate.
  5. Add failures from crawlee actor into the improvement backlog.
- Production rule: if this item cannot be verified, mark it as risk, not as done.

### 5. Extractor validation
- Purpose: Apply **Extractor validation** specifically to this skill.
- Steps:
  1. Define how extractor validation supports the user goal.
  2. Identify required input, output, owner, and risk level for extractor validation.
  3. Create a typed artifact for extractor validation so the orchestrator can review it.
  4. Validate extractor validation with a test, trace, or human review gate.
  5. Add failures from extractor validation into the improvement backlog.
- Production rule: if this item cannot be verified, mark it as risk, not as done.

### 6. Provenance store
- Purpose: Apply **Provenance store** specifically to this skill.
- Steps:
  1. Define how provenance store supports the user goal.
  2. Identify required input, output, owner, and risk level for provenance store.
  3. Create a typed artifact for provenance store so the orchestrator can review it.
  4. Validate provenance store with a test, trace, or human review gate.
  5. Add failures from provenance store into the improvement backlog.
- Production rule: if this item cannot be verified, mark it as risk, not as done.

### 7. Deduplication
- Purpose: Apply **Deduplication** specifically to this skill.
- Steps:
  1. Define how deduplication supports the user goal.
  2. Identify required input, output, owner, and risk level for deduplication.
  3. Create a typed artifact for deduplication so the orchestrator can review it.
  4. Validate deduplication with a test, trace, or human review gate.
  5. Add failures from deduplication into the improvement backlog.
- Production rule: if this item cannot be verified, mark it as risk, not as done.

### 8. RAG ingestion
- Purpose: Apply **RAG ingestion** specifically to this skill.
- Steps:
  1. Define how rag ingestion supports the user goal.
  2. Identify required input, output, owner, and risk level for rag ingestion.
  3. Create a typed artifact for rag ingestion so the orchestrator can review it.
  4. Validate rag ingestion with a test, trace, or human review gate.
  5. Add failures from rag ingestion into the improvement backlog.
- Production rule: if this item cannot be verified, mark it as risk, not as done.
...
1. **Scrapy** — use only with explicit scope, testability, and ownership.
2. **Crawlee** — use only with explicit scope, testability, and ownership.
3. **BeautifulSoup** — use only with explicit scope, testability, and ownership.
4. **trafilatura** — use only with explicit scope, testability, and ownership.
5. **readability-lxml** — use only with explicit scope, testability, and ownership.
6. **robots parser** — use only with explicit scope, testability, and ownership.
7. **Postgres** — use only with explicit scope, testability, and ownership.
8. **DuckDB** — use only with explicit scope, testability, and ownership.
...
{
  "run_id": "uuid",
  "skill": "forge-public-data-scrapy-crawlee-agent",
